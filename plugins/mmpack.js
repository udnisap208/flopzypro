...
const Ln = "MEME PACK "
const code = "❖═NEW MEME PACK═❖\n\n*💠.yasai* text\n*💠.uddika* text\n*💠.aah* text\n*💠.my3* text\n*💠.mf* text\n*💠.hii* text\n*💠.asai* text\n*💠.hapoi* text\n*💠.anura* text\n*💠.gemba* text\n*💠.wow* text\n*💠.hapo* text\n*💠.babah* text\n*💠.mcn* text\n*💠.nah* text\n"

if (Config.WORKTYPE == 'public') {
    
     XTroid.addCMD({pattern: 'mmpack', fromMe: false, desc: Ln,}, (async (message, match) => {
 ...
 XTroid.addCMD({ pattern: 'my3 ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'mf ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'hii ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'yasai ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'hapoi ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'uddika ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'aah ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'asai ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'wow ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'hapo ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'anura ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'macn ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'babah ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'gemba ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'nah ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'kaluhutta ?(.*)', fromMe: false, dontAddCMDList: true }, (async (message, match) => {
...
if (Config.WORKTYPE == 'private') {
      ...
      XTroid.addCMD({pattern: 'mmpack', fromMe: true, desc: Ln,}, (async (message, match) => {
    ...
    XTroid.addCMD({ pattern: 'my3 ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'mf ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'hii ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'yasai ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'hapoi ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'uddika ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'aah ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'asai ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'wow ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'hapo ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'anura ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'macn ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'babah ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'gemba ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'nah ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
...
XTroid.addCMD({ pattern: 'kaluhutta ?(.*)', fromMe: true, dontAddCMDList: true }, (async (message, match) => {
