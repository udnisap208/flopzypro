...
if (Config.WORKTYPE == 'private') {
    ...
    DEx.addCMD({pattern: 'png ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
    ...
    DEx.addCMD({pattern: 'png ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
    ...
    DEx.addCMD({pattern: 'png ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
