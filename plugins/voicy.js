...
if (conf.WORKTYPE == 'private') {
    ...
    DEx.addCMD({ pattern: 'voicy', desc: Lang.USAGE, fromMe: true }, (async (message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    DEx.addCMD({ pattern: 'voicy', desc: Lang.USAGE, fromMe: false }, (async (message, match) => {
    ...
    DEx.addCMD({ pattern: 'voicy', desc: Lang.USAGE, fromMe: true, dontAddCMDList: true }, (async (message, match) => {
