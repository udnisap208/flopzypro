...
if (Config.WORKTYPE == 'private') {
    DEx.addCMD({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    DEx.addCMD({pattern: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    DEx.addCMD({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC, dontAddCMDList: true}, (async (message, match) => {    
