...
if (Config.WORKTYPE == 'private') {
    ...
    DEx.addCMD({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true}, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    DEx.addCMD({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: false}, async (message, match) => {
    ...
    DEx.addCMD({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: false, dontAddCMDList: true}, async (message, match) => {
